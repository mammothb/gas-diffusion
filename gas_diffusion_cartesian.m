...
L_NO = spdiags([ones(nr_i, 1); 2; 0], -1, nr, nr);
U_NO = spdiags([0; 2; ones(nr_i, 1)], 1, nr, nr);
...
for cfl_width = 1 : 5
  ...
  D_O2 = spdiags([1; -2 * ones(nr_i - nr_i_01 + 1, 1)], 0, nr - nr_i_01,...
      nr - nr_i_01);
  L_O2 = spdiags([ones(nr_i - nr_i_01, 1); 2; 0], -1, nr - nr_i_01, nr - nr_i_01);
  U_O2 = spdiags([0; 0; ones(nr_i - nr_i_01, 1)], 1, nr - nr_i_01, nr - nr_i_01);
